    ...
    <div class="detail-wrp">
      <div class="container">
        <div class="row flex-column">
          ...
          <taskForm /> <!-- Adaylık için form doldurma -->
        </div>
      </div>
    </div>
    <taskSuccessForm /> <!--Aday olunca çıkan "başarılı" mesajı -->
  </div>
</template>

<script>
import taskInfo from "../components/private-lessons-detail/task-info";
import taskForm from "../components/private-lessons-detail/task-form";
import taskSuccessForm from "../components/private-lessons-detail/task-success-popup";
export default {
